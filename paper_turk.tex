...
Human observers are needed to evaluate lineups that are used to test the significance of findings using statistical graphics. This paper presents an online tool that can be used to recruit human participants to get evaluations on lineup.
...
\begin{figure}[hbtp]
   \centering
       \scalebox{.6}{\includegraphics{rejected_task.pdf}}
