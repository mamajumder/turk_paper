...
This paper is organized as follows. Section \ref{sec:turk_exp} presents the details description of an experiment and things to consider before a turk experiment. Section \ref{sec:web_application} presents the design of an web application to get lineups evaluated with additional flexibilities and options that may not possible through MTurk. Section \ref{sec:turk_task} describes how to create a MTurk task, mange workers and process payments. Finally Section \ref{sec:turk_data} presents some data obtained from various experiments done through the proposed web application and discusses about the quality of the data.
