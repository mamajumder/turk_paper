...
\item Appreciate work

\item Reply query email promptly

\item Block workers if necessary
...
While selection bias is very important for some experimental study it is not much of an issue for experiment with lineups. If we examine the diversity of the participants in \ref{majumder:turk} we see that the turk data provide data from a very diverse population. Moreover it is observed in XXX that diversity is not much important for lineups as the human factors do not have any practical impact on the probability of correctly identifying the data plot in the lineup. 
